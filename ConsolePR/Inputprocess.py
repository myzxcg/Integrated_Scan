...
def CmdParse():
    ...
    parser.add_argument('-sub', dest='sub',
                        action='store_true', help='Blasting subdomains')
    parser.add_argument('-nmap', dest='nmap',
                        action='store_true', help='Port scanning for ip')
    parser.add_argument('-dirscan', dest='dirscan',
                        action='store_true', help=' Blast scan the web directory')
    parser.add_argument('-subn', dest='sub_nmap', action='store_true',
                        help='Blasting subdomains and Port scan')
    ...
    # 设定进程/线程
    parser.add_argument('-t', dest='threads', default=200,
                        type=int, help="sub Blasting module's threads,default=200")
    ...
    parser.add_argument('-u', dest='Host_Url', default=None,
                        type=str, help='Port scan ip/Ip segment or subdomain')
    parser.add_argument('-o', dest='output', default=None,
                        type=str, help='Output filename')

    parser.add_argument('-f', dest='file', default='subnames.txt',
                        help="subdomain's file,default is subnames.txt")
